...
[Graduate. Spring 2026 (next offering); previously Spring 2025.]{.pub-venue}

[Graduate-level introduction to statistical modeling, with a focus on OLS regression. The course covers mechanics, inference, DAGs, bad controls, interactions, diagnostics, potential outcomes, matching, and panel / fixed-effects models. Built around Gelman, Hill, and Vehtari's *Regression and Other Stories*.]{.pub-abstract}

::: {.pub-links}
[Syllabus (Spring 2025)](assets/syllabi/pos6747-linear-models-sp25.pdf)
:::
:::
...
[Graduate. Pre-term refresher, Fall 2024.]{.pub-venue}
...
::: {.pub-links}
[Syllabus (Fall 2024)](assets/syllabi/math-workshop-f24.pdf)
:::
:::
